...
// Variables
const rootDomain = "mbleh-vpn.biz.id"; // Ganti dengan domain utama kalian
const serviceName = "trojan"; // Ganti dengan nama workers kalian
const apiKey = "6hy_7nSb9UGOKMtmKQd7Ps715ecK8tWEJ-5NIF7x"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "kepokasuh1@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "86378c119d311efa003a4bdf83bec804"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "60e7fd8f0f7737cae06c6f2e1e3017d8"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
